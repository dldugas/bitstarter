...
var cheerioUrlFile = function(urlfile) {
    return cheerio.load(restUrlFile(urlfile));
};

var restUrlFile = function(urlfile) {
    var urlHtml = rest.get(urlfile).on('complete', function(result) {
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <url_path>', 'URL Path to index.html', clone(assertURLExists), URLPATH_DEFAULT)
        .parse(process.argv);
